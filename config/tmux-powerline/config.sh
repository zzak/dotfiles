...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="zzak"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/kg/6z9856y91t10b8nngbmf3pd40000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/zzak/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/zzak/.mailcheckrc"
# }
